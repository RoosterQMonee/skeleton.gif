...
4. update the `rows`,`cols` and `frame_count` variables in main.c according to the outputted `assets/meta.json` file (you can comment/uncomment `PLAY_AUDIO` if you want to remove/include riff.mp3!)
5. run `build.bat`
